...
namespace Sabio.Web.Api.Controllers
{
    ...
    public class UserApiController : BaseApiController
    {
        ...
        public ActionResult<ItemResponse<InitialUser>> SelectById(int id)
        {
            InitialUser user = null;
            BaseResponse response = null;
            int code = 0;
        ...
        [HttpPost("parentstudents/{studentEmail}")]
        public ActionResult<SuccessResponse> InitiateParentStudentRelationship(InitialUser parent, string studentEmail)
        {
            int code = 200;
            BaseResponse response = null;
            ...
            try
            {
                _userService.ParentStudentToken(parent, studentEmail);
                response = new SuccessResponse();
            }
            catch (Exception ex)
            {
        ...
        [HttpPut("parentstudenttoken/{tokenId}")]
        public ActionResult ConfirmUpdate(string tokenId)
        {
            int userId = _authService.GetCurrentUserId();
            int code = 0;
            BaseResponse response = null;
            ...
            try
            {
                if (userId != 0)
                {
                    _userService.ParentStudentConfirmUpdate(tokenId);
                    code = 200;
                    response = new SuccessResponse();
                }
                else
        ...
        [HttpGet("confirmation/{isConfirmed:bool}")]
        public ActionResult<ItemsResponse<ParentStudent>> SelectByConfirmation(bool isConfirmedValue)
        {
            int iCode = 200;
            BaseResponse response = null;
            try
            {
                List<ParentStudent> list = _userService.SelectByIsConfirmed(isConfirmedValue);
                if (list == null)
                {
                    iCode = 404;
                ...
                {
                    response = new ItemsResponse<ParentStudent> { Items = list };
        ...
        [HttpDelete("parentstudent/{pId:int}/{sId:int}")]
        public ActionResult<SuccessResponse> DeleteParentStudent(int pId, int sId)
        {
            int code = 200;
            BaseResponse response = null;
            ...
            try
            {
                _userService.ParentStudentDelete(pId, sId);
                response = new SuccessResponse();
            }
            catch (Exception ex)
            {
        ...
        [HttpPost("parentstudent/{pId:int}/{sId:int}")]
        public ActionResult<SuccessResponse> AddParentStudent(int pId, int sId)
        {
            int code = 200;
            BaseResponse response = null;
            ...
            try
            {
                _userService.ParentStudentAdd(pId, sId);
                response = new SuccessResponse();
            }
            catch (Exception ex)
            {
        ...
        [HttpGet("parentPage")]
        public ActionResult<ItemResponse<Paged<ParentStudent>>> GetPaginated(int pageIndex, int pageSize)
        {

            ObjectResult result = null;
            try
            {
                Paged<ParentStudent> page = _userService.ParentStudentPaginate(pageIndex, pageSize);
                if (page == null)
                {
                ...
                {
                    ItemResponse<Paged<ParentStudent>> response = new ItemResponse<Paged<ParentStudent>> { Item = page };
                    result = Ok200(response);
                }
            }
            catch (Exception ex)
        ...
        [HttpGet("parentId/{id:int}")]
        public ActionResult SelectByParentId(int id)
        {
            int iCode = 200;
            BaseResponse response = null;
            try
            {
                List<ParentStudentUsersTable> user = _userService.SelectByParentId(id);
                if (user == null)
                {
                    iCode = 404;
                    response = new ErrorResponse("Application Resource not found.");
                ...
                {
                    response = new ItemsResponse<ParentStudentUsersTable> { Items = user };
                }
            }
            catch (Exception ex)
            {
        ...
        public ActionResult SelectByStudentId(int id)
        {
            int iCode = 200;
            BaseResponse response = null;
            try
            {
                List<ParentStudentUsersTable> user = _userService.SelectByStudentId(id);
                if (user == null)
                {
                    iCode = 404;
                    response = new ErrorResponse("Application Resource not found.");
        ...
        [HttpGet("parentstudent/{ParentId:int}")]
        public ActionResult<ItemsResponse<ParentStudentExpirationRequest>> ById(int ParentId)
        {
            int iCode = 200;
            BaseResponse response = null;
            try
            {
                List<ParentStudentExpirationRequest> list = _userService.ById(ParentId);
                if (list == null)
                {
                    iCode = 404;
                    response = new ErrorResponse("Application Resource not found.");
                ...
                {
                    response = new ItemsResponse<ParentStudentExpirationRequest> { Items = list };
